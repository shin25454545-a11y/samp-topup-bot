...
# --- 1. จัดการข้อมูลเงิน (ฉบับรองรับ Replit และเซฟถาวร) ---
def load_data():
...
intents.members = True # อย่าลืมเปิด Member Intent ใน Discord Developer Portal ด้วยนะครับ!
...
# ใช้ Token จาก Environment Variables ของ Replit
